...
$id          = filter_input(INPUT_GET, 'article_id', FILTER_VALIDATE_INT); // Get id + validate
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {                 // If form submitted
    ...
    $errors['image_file'] = (isset($_FILES['image']) and $_FILES['image']['error'] === 1) ? 'File too big ' : '';
    ...
    if ($invalid) {                                              // If invalid
        ...
        try {                                                    // Try to insert data
            ...
            if ($id) {
                ...
                unset($arguments['article_id']);                         // Remove id
